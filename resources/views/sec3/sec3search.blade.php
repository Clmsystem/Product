            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="page-header">
                        <h3 class="newFont">ส่วนที่ 3 ตัวชี้วัดผลการปฏิบัติงานตามภารกิจของหน่วยงาน ประจำปีงบประมาณ {{$year}}</h3>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="button-position">
                            <form action="{{route('downloadsec3')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <table class="table table-bordered newFont">
                                    ...
                                    <tbody>
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-sm-1 break textleft"> {{$data->unit_name}} </td>
                                            <td class="col-sm-2 break textleft"> {{$data->name_employee}} </td>
                                            <td class="col-sm-2 break">
                                                <a target='_blank' href="sec3dashboard?id={{$data->indicator_result_ID}}&year={{$data->year_id}}"><button type="button" class="Pbtn btn btn-inverse-success"><i class="mdi mdi-chart-bar"></i></button></a>
                                            </td>
